...
export default function WaitinglistForm() {
    ...
    return (
        ...
        <div className="border border-foreground/10 p-2 rounded-2xl bg-foreground/5 md:w-fit w-full md:flex md:flex-row flex-col">
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Jouw emailadres" required className="bg-transparent md:text-left text-center md:placeholder:text-left placeholder:text-center md:mb-0 mb-2 outline-none border-none py-3 px-4 md:w-[240px] w-full" />
